...
template <typename T>
auto add_value(vtkStructuredGrid *structuredGrid, const char *name,
               T default_value) {
...
auto make_structuredgrid(const points_vector<T, dim> &pts, size_t ni, size_t nj)
...
inline auto make_structuredgrid_actor(
    const vtkSmartPointer<vtkStructuredGrid> &structuredGrid)
    -> vtkSmartPointer<vtkActor>
// inline auto make_structuredgrid_actor(vtkStructuredGrid *structuredGrid) ->
// vtkSmartPointer<vtkActor>
{
...
template <typename T, size_t dim>
auto make_structuredgrid_actor(const points_vector<T, dim> &pts, size_t ni,
                               size_t nj) -> vtkSmartPointer<vtkActor> {
